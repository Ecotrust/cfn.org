...
function sc_lead ($atts, $content) {
	...
	$output = "";
	$output .= "<span class='lead'>$content</span>";
...
function sc_button ($atts, $content) {
	...
	$output = "";
	$output .= "<a href='$url' class='$class'>$content</a>";
...
function sc_lightbox_media ($atts, $content) {
	...
	$output .= "<div class='clearfix'>";
	$output .= "<div class='mosaic-block fade'>";
	$output .= "<a href='$content' class='mosaic-overlay fancybox fancybox.iframe' $fancybox_group rel='gallery'></a>";
	$output .= "<div class='mosaic-backdrop'>";
	$output .= "<img src='$src' alt='$title' />";
	$output .= "</div>";
	$output .= "</div>";
...
function sc_img_slider ($atts, $content) {
	...
	$output = "";
	$output .= "<div class='flexslider sc_flexslider'><ul class='slides'>";
	$output .= do_shortcode($content);
	$output .= "</ul></div>";
...
function sc_quote_slider ($atts, $content) {
	...
	$output = "";
	$output .= "<div class='flexslider sc_flexslider-quote'><ul class='slides'>";
	$output .= do_shortcode($content);
	$output .= "</ul></div>";
...
function sc_quote_slide ($atts, $content) {
	...
	$output = "";
	$output .= "<li>";
	$output .= "<blockquote>$content</blockquote><cite>$byline</cite>";
	$output .= "</li>";
...
function sc_blockquote ($atts, $content) {
	...
	$class = $size;
	$class = ($align == "left") ? $class : $class . " right last";

	$output = "";
	$output .= "<blockquote class='$class'>";
	$output .= do_shortcode($content);
	$output .=  "<cite>$byline</cite>";
	$output .= "</blockquote>";
