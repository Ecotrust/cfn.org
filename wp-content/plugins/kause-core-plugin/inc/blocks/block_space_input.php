<?php
	function block_space_input ($passed_vars) {
		...
		?>
			...
			<li class="building_block block_space">

				<div class="block_header">
					<?php _e("Vertical Space", "loc_kause_core_plugin"); ?>
				...
				<!-- NUMBER -->
					<div class="option">
						...
						><?php _e("Pixels", "loc_kause_core_plugin"); ?>
					</div>

					<hr>

					<h4><?php _e("Responsive modes", "loc_kause_core_plugin"); ?></h4>
