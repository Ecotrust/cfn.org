                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class("clearfix"); ?>>
                            ...
                            <aside class="left-aside left fifth">
                                <ul class="meta">
                               		...
                               		<?php if ($canon_options_post['show_person_tagline'] == "checked") { if (!empty($cmb_tagline)) { printf('<li class="meta_tagline">%s</li>', $cmb_tagline); } } ?>
								</ul>	
                                    <?php 
                                    ...
                                    ?>
                                <!-- Adding the members sidebar -->
                               <?php // FAILSAFE DEFAULT
